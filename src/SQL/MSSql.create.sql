...
CREATE INDEX FullTypesMainAgregator_IFullTypesMaster1_m0 on [FullTypesMainAgregator] ([FullTypesMaster1_m0])
 ...
 ALTER TABLE [Apparatus2] ADD CONSTRAINT [Apparatus2_FCountry2_0] FOREIGN KEY ([Exporter_m0]) REFERENCES [Country2]
CREATE INDEX Apparatus2_IExporter_m0 on [Apparatus2] ([Exporter_m0])

 ALTER TABLE [Apparatus2] ADD CONSTRAINT [Apparatus2_FCountry2_1] FOREIGN KEY ([Maker_m0]) REFERENCES [Country2]
...
CREATE INDEX InformationTestClass3_IInformationTestClass2 on [InformationTestClass3] ([InformationTestClass2])
 ...
 ALTER TABLE [CabbageSalad] ADD CONSTRAINT [CabbageSalad_FCabbage2_0] FOREIGN KEY ([Cabbage2]) REFERENCES [Cabbage2]
CREATE INDEX CabbageSalad_ICabbage2 on [CabbageSalad] ([Cabbage2])

 ALTER TABLE [CabbageSalad] ADD CONSTRAINT [CabbageSalad_FCabbage2_1] FOREIGN KEY ([Cabbage1]) REFERENCES [Cabbage2]
