...
(
	...
	"DeliveredByMailman" RAW(16) NULL,

	"DeliveredByHomer" RAW(16) NULL,
...
ALTER TABLE "Parcel"
	ADD CONSTRAINT "Parcel_FMailman_0" FOREIGN KEY ("DeliveredByMailman") REFERENCES "Mailman" ("primaryKey");

CREATE INDEX "Parcel_IDeliveredByMailman" on "Parcel" ("DeliveredByMailman");

ALTER TABLE "Parcel"
	ADD CONSTRAINT "Parcel_FHomer_0" FOREIGN KEY ("DeliveredByHomer") REFERENCES "Homer" ("primaryKey");
...
ALTER TABLE "Apparatus2"
	ADD CONSTRAINT "Apparatus2_FCountry2_0" FOREIGN KEY ("Exporter_m0") REFERENCES "Country2" ("primaryKey");

CREATE INDEX "Apparatus2_IExporter_m0" on "Apparatus2" ("Exporter_m0");

ALTER TABLE "Apparatus2"
	ADD CONSTRAINT "Apparatus2_FCountry2_1" FOREIGN KEY ("Maker_m0") REFERENCES "Country2" ("primaryKey");
...
ALTER TABLE "Place2"
	ADD CONSTRAINT "Place2_FCountry2_0" FOREIGN KEY ("TomorrowTeritory_m0") REFERENCES "Country2" ("primaryKey");

CREATE INDEX "Place2_ITomorrowTeritory_m0" on "Place2" ("TomorrowTeritory_m0");

ALTER TABLE "Place2"
	ADD CONSTRAINT "Place2_FTerritory2_0" FOREIGN KEY ("TomorrowTeritory_m1") REFERENCES "Territory2" ("primaryKey");

CREATE INDEX "Place2_ITomorrowTeritory_m1" on "Place2" ("TomorrowTeritory_m1");

ALTER TABLE "Place2"
	ADD CONSTRAINT "Place2_FCountry2_1" FOREIGN KEY ("TodayTerritory_m0") REFERENCES "Country2" ("primaryKey");

CREATE INDEX "Place2_ITodayTerritory_m0" on "Place2" ("TodayTerritory_m0");

ALTER TABLE "Place2"
	ADD CONSTRAINT "Place2_FTerritory2_1" FOREIGN KEY ("TodayTerritory_m1") REFERENCES "Territory2" ("primaryKey");
...
ALTER TABLE "CabbageSalad"
	ADD CONSTRAINT "CabbageSalad_FCabbage2_0" FOREIGN KEY ("Cabbage2") REFERENCES "Cabbage2" ("primaryKey");

CREATE INDEX "CabbageSalad_ICabbage2" on "CabbageSalad" ("Cabbage2");

ALTER TABLE "CabbageSalad"
	ADD CONSTRAINT "CabbageSalad_FCabbage2_1" FOREIGN KEY ("Cabbage1") REFERENCES "Cabbage2" ("primaryKey");
