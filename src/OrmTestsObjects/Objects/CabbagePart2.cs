...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class CabbagePart2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Cabbage2 fCabbage;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.Cabbage2.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cabbage"})]
        public virtual NewPlatform.OrmTestsObjects.Cabbage2 Cabbage
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Cabbage2 result = this.fCabbage;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CabbagePart2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CabbagePart2E", typeof(NewPlatform.OrmTestsObjects.CabbagePart2));
                }
            }
        }
    }
    ...
    public class DetailArrayOfCabbagePart2 : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2 members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2 members)
        ...
        /// </summary>
        public DetailArrayOfCabbagePart2(NewPlatform.OrmTestsObjects.Cabbage2 fCabbage2) : 
                base(typeof(CabbagePart2), ((ICSSoft.STORMNET.DataObject)(fCabbage2)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.CabbagePart2 this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.CabbagePart2)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.CabbagePart2 dataobject)
        {
