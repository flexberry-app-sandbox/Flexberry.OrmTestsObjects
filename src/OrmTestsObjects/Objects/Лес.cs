...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Лес : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Страна fСтрана;
        ...
        [PropertyStorage(new string[] {
                "Страна"})]
        public virtual NewPlatform.OrmTestsObjects.Страна Страна
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Страна result = this.fСтрана;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛесE", typeof(NewPlatform.OrmTestsObjects.Лес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛесL", typeof(NewPlatform.OrmTestsObjects.Лес));
                }
            }
        }
    }
