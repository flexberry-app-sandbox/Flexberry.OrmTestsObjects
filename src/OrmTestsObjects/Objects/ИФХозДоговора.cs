...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class ИФХозДоговора : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.ИсточникФинансирования fИсточникФинансирования;
        ...
        [PropertyStorage(new string[] {
                "ИсточникФинан"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.ИсточникФинансирования ИсточникФинансирования
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ИсточникФинансирования result = this.fИсточникФинансирования;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИФХозДоговораE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИФХозДоговораE", typeof(NewPlatform.OrmTestsObjects.ИФХозДоговора));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИФХозДоговора : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfИФХозДоговора members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfИФХозДоговора members)
        ...
        /// </summary>
        public DetailArrayOfИФХозДоговора(NewPlatform.OrmTestsObjects.ХозДоговор fХозДоговор) : 
                base(typeof(ИФХозДоговора), ((ICSSoft.STORMNET.DataObject)(fХозДоговор)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.ИФХозДоговора this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.ИФХозДоговора)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.ИФХозДоговора dataobject)
        {
