...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class ФайлИдеи : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Пользователь fВладелец;
        ...
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Пользователь Владелец
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Пользователь result = this.fВладелец;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФайлE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФайлE", typeof(NewPlatform.OrmTestsObjects.ФайлИдеи));
                }
            }
        }
    }
    ...
    public class DetailArrayOfФайлИдеи : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfФайлИдеи members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfФайлИдеи members)
        ...
        /// </summary>
        public DetailArrayOfФайлИдеи(NewPlatform.OrmTestsObjects.Идея fИдея) : 
                base(typeof(ФайлИдеи), ((ICSSoft.STORMNET.DataObject)(fИдея)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.ФайлИдеи this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.ФайлИдеи)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.ФайлИдеи dataobject)
        {
