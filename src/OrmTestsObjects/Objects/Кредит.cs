...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Кредит : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.ВидКредита fВидКредита;
        
        private NewPlatform.OrmTestsObjects.ИнспекторПоКредиту fИнспекторПоКредиту;
        
        private NewPlatform.OrmTestsObjects.Клиент fКлиент;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfВыплаты fВыплаты;
        ...
        public virtual NewPlatform.OrmTestsObjects.ВидКредита ВидКредита
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ВидКредита result = this.fВидКредита;
        ...
        [PropertyStorage(new string[] {
                "ИнспекторПоКред"})]
        public virtual NewPlatform.OrmTestsObjects.ИнспекторПоКредиту ИнспекторПоКредиту
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ИнспекторПоКредиту result = this.fИнспекторПоКредиту;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        public virtual NewPlatform.OrmTestsObjects.Клиент Клиент
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Клиент result = this.fКлиент;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfВыплаты Выплаты
        {
            get
            {
                ...
                {
                    this.fВыплаты = new NewPlatform.OrmTestsObjects.DetailArrayOfВыплаты(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfВыплаты result = this.fВыплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View C__КредитE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("C__КредитE", typeof(NewPlatform.OrmTestsObjects.Кредит));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КредитViewE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КредитViewE", typeof(NewPlatform.OrmTestsObjects.Кредит));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КредитViewL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КредитViewL", typeof(NewPlatform.OrmTestsObjects.Кредит));
                }
            }
        }
    }
