...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class SomeDetailClass : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.SomeMasterClass fSomeMasterClass;
        ...
        [PropertyStorage(new string[] {
                "ClassA"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.SomeMasterClass SomeMasterClass
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.SomeMasterClass result = this.fSomeMasterClass;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ClassBE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ClassBE", typeof(NewPlatform.OrmTestsObjects.SomeDetailClass));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ClassBL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ClassBL", typeof(NewPlatform.OrmTestsObjects.SomeDetailClass));
                }
            }
        }
    }
