...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class clb : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.cla fref1;
        
        private NewPlatform.OrmTestsObjects.cla fref2;
        ...
        [PropertyStorage(new string[] {
                "ref1"})]
        public virtual NewPlatform.OrmTestsObjects.cla ref1
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.cla result = this.fref1;
        ...
        [PropertyStorage(new string[] {
                "ref2"})]
        public virtual NewPlatform.OrmTestsObjects.cla ref2
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.cla result = this.fref2;
