...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Place2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Territory2 fTodayTerritory;
        
        private NewPlatform.OrmTestsObjects.Territory2 fTomorrowTeritory;
        ...
        [TypeUsage(new string[] {
                "NewPlatform.OrmTestsObjects.Country2",
                "NewPlatform.OrmTestsObjects.Territory2"})]
        public virtual NewPlatform.OrmTestsObjects.Territory2 TodayTerritory
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Territory2 result = this.fTodayTerritory;
        ...
        [TypeUsage(new string[] {
                ...
                "NewPlatform.OrmTestsObjects.Territory2"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Territory2 TomorrowTeritory
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Territory2 result = this.fTomorrowTeritory;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Place2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Place2E", typeof(NewPlatform.OrmTestsObjects.Place2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Place2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Place2L", typeof(NewPlatform.OrmTestsObjects.Place2));
                }
            }
        }
    }
