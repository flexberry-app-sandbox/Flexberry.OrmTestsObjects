...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class AuditAgregatorObject : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.AuditMasterObject fMasterObject;
        ...
        [PropertyStorage(new string[] {
                "MasterObject"})]
        public virtual NewPlatform.OrmTestsObjects.AuditMasterObject MasterObject
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.AuditMasterObject result = this.fMasterObject;
