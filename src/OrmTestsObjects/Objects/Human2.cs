...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Human2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Territory2 fTodayHome;
        ...
        public virtual NewPlatform.OrmTestsObjects.Territory2 TodayHome
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Territory2 result = this.fTodayHome;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Human2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Human2E", typeof(NewPlatform.OrmTestsObjects.Human2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Human2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Human2L", typeof(NewPlatform.OrmTestsObjects.Human2));
                }
            }
        }
    }
