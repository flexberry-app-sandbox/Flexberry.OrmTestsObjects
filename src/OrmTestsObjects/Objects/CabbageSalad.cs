...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class CabbageSalad : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Cabbage2 fCabbage1;
        
        private NewPlatform.OrmTestsObjects.Cabbage2 fCabbage2;
        ...
        [PropertyStorage(new string[] {
                "Cabbage1"})]
        public virtual NewPlatform.OrmTestsObjects.Cabbage2 Cabbage1
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Cabbage2 result = this.fCabbage1;
        ...
        [PropertyStorage(new string[] {
                "Cabbage2"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Cabbage2 Cabbage2
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Cabbage2 result = this.fCabbage2;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CabbageSaladE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CabbageSaladE", typeof(NewPlatform.OrmTestsObjects.CabbageSalad));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CabbageSaladL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CabbageSaladL", typeof(NewPlatform.OrmTestsObjects.CabbageSalad));
                }
            }
        }
    }
