...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class УчастникХозДоговора : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.tСтатусИсполнителяХозДоговора fСтатус;
        
        private NewPlatform.OrmTestsObjects.Личность fЛичность;
        
        private NewPlatform.OrmTestsObjects.ХозДоговор fХозДоговор;
        ...
        public virtual NewPlatform.OrmTestsObjects.tСтатусИсполнителяХозДоговора Статус
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.tСтатусИсполнителяХозДоговора result = this.fСтатус;
        ...
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Личность Личность
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Личность result = this.fЛичность;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.ХозДоговор.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.ХозДоговор ХозДоговор
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ХозДоговор result = this.fХозДоговор;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УчастникХозДоговораE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УчастникХозДоговораE", typeof(NewPlatform.OrmTestsObjects.УчастникХозДоговора));
                }
            }
        }
    }
    ...
    public class DetailArrayOfУчастникХозДоговора : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfУчастникХозДоговора members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfУчастникХозДоговора members)
        ...
        /// </summary>
        public DetailArrayOfУчастникХозДоговора(NewPlatform.OrmTestsObjects.ХозДоговор fХозДоговор) : 
                base(typeof(УчастникХозДоговора), ((ICSSoft.STORMNET.DataObject)(fХозДоговор)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.УчастникХозДоговора this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.УчастникХозДоговора)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.УчастникХозДоговора dataobject)
        {
