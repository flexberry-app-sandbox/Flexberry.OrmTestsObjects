...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Порода : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Порода fИерархия;
        
        private NewPlatform.OrmTestsObjects.ТипПороды fТипПороды;
        ...
        [PropertyStorage(new string[] {
                "Иерархия"})]
        public virtual NewPlatform.OrmTestsObjects.Порода Иерархия
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Порода result = this.fИерархия;
        ...
        [PropertyStorage(new string[] {
                "ТипПороды"})]
        public virtual NewPlatform.OrmTestsObjects.ТипПороды ТипПороды
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ТипПороды result = this.fТипПороды;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View k_ПородаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("k_ПородаE", typeof(NewPlatform.OrmTestsObjects.Порода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View k_ПородаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("k_ПородаL", typeof(NewPlatform.OrmTestsObjects.Порода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПородаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПородаE", typeof(NewPlatform.OrmTestsObjects.Порода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПородаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПородаL", typeof(NewPlatform.OrmTestsObjects.Порода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПородаwwwwL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПородаwwwwL", typeof(NewPlatform.OrmTestsObjects.Порода));
                }
            }
        }
    }
