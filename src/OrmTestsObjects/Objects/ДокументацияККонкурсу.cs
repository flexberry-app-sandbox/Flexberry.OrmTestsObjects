...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class ДокументацияККонкурсу : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.Конкурс.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументацияККонкурсуE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументацияККонкурсуE", typeof(NewPlatform.OrmTestsObjects.ДокументацияККонкурсу));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументацияККонкурсу : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу members)
        ...
        /// </summary>
        public DetailArrayOfДокументацияККонкурсу(NewPlatform.OrmTestsObjects.Конкурс fКонкурс) : 
                base(typeof(ДокументацияККонкурсу), ((ICSSoft.STORMNET.DataObject)(fКонкурс)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.ДокументацияККонкурсу this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.ДокументацияККонкурсу)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.ДокументацияККонкурсу dataobject)
        {
