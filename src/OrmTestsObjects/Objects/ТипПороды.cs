    ...
    public class ТипПороды : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Актуальность
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Актуальность", typeof(NewPlatform.OrmTestsObjects.ТипПороды));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТипПородыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТипПородыE", typeof(NewPlatform.OrmTestsObjects.ТипПороды));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТипПородыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТипПородыL", typeof(NewPlatform.OrmTestsObjects.ТипПороды));
                }
            }
        }
    }
