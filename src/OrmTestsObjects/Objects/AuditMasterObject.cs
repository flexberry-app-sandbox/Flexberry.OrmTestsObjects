...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class AuditMasterObject : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.AuditMasterMasterObject fMasterObject;
        ...
        [PropertyStorage(new string[] {
                "MasterObject"})]
        public virtual NewPlatform.OrmTestsObjects.AuditMasterMasterObject MasterObject
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.AuditMasterMasterObject result = this.fMasterObject;
