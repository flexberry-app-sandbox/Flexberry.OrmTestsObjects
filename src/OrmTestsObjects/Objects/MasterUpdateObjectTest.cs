...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class MasterUpdateObjectTest : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.DetailUpdateObjectTest fDetail;
        ...
        [PropertyStorage(new string[] {
                "Detail"})]
        public virtual NewPlatform.OrmTestsObjects.DetailUpdateObjectTest Detail
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.DetailUpdateObjectTest result = this.fDetail;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View MasterUpdateObjectTestE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("MasterUpdateObjectTestE", typeof(NewPlatform.OrmTestsObjects.MasterUpdateObjectTest));
                }
            }
        }
    }
    ...
    public class DetailArrayOfMasterUpdateObjectTest : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfMasterUpdateObjectTest members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfMasterUpdateObjectTest members)
        ...
        /// </summary>
        public DetailArrayOfMasterUpdateObjectTest(NewPlatform.OrmTestsObjects.AggregatorUpdateObjectTest fAggregatorUpdateObjectTest) : 
                base(typeof(MasterUpdateObjectTest), ((ICSSoft.STORMNET.DataObject)(fAggregatorUpdateObjectTest)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.MasterUpdateObjectTest this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.MasterUpdateObjectTest)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.MasterUpdateObjectTest dataobject)
        {
