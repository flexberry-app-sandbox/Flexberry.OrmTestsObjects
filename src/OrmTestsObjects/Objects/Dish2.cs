...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Dish2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Plant2 fMainIngridient;
        ...
        public virtual NewPlatform.OrmTestsObjects.Plant2 MainIngridient
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Plant2 result = this.fMainIngridient;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Dish2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Dish2E", typeof(NewPlatform.OrmTestsObjects.Dish2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Dish2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Dish2L", typeof(NewPlatform.OrmTestsObjects.Dish2));
                }
            }
        }
    }
