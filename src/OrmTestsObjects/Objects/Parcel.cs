...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Parcel : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Homer fDeliveredByHomer;
        
        private NewPlatform.OrmTestsObjects.Mailman fDeliveredByMailman;
        ...
        [PropertyStorage(new string[] {
                "DeliveredByHomer"})]
        public virtual NewPlatform.OrmTestsObjects.Homer DeliveredByHomer
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Homer result = this.fDeliveredByHomer;
        ...
        [PropertyStorage(new string[] {
                "DeliveredByMailman"})]
        public virtual NewPlatform.OrmTestsObjects.Mailman DeliveredByMailman
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Mailman result = this.fDeliveredByMailman;
