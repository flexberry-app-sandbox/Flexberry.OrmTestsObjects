...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class ЭтапИсходящегоЗапроса : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.КонфигурацияЗапроса fКонфигурация;
        
        private NewPlatform.OrmTestsObjects.ИсходящийЗапрос fЗапросы;
        ...
        [PropertyStorage(new string[] {
                "Конфигурация"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.КонфигурацияЗапроса Конфигурация
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.КонфигурацияЗапроса result = this.fКонфигурация;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.ИсходящийЗапрос.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Запросы"})]
        public virtual NewPlatform.OrmTestsObjects.ИсходящийЗапрос Запросы
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ИсходящийЗапрос result = this.fЗапросы;
    ...
    public class DetailArrayOfЭтапИсходящегоЗапроса : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса members)
        ...
        /// </summary>
        public DetailArrayOfЭтапИсходящегоЗапроса(NewPlatform.OrmTestsObjects.ИсходящийЗапрос fИсходящийЗапрос) : 
                base(typeof(ЭтапИсходящегоЗапроса), ((ICSSoft.STORMNET.DataObject)(fИсходящийЗапрос)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.ЭтапИсходящегоЗапроса this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.ЭтапИсходящегоЗапроса)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.ЭтапИсходящегоЗапроса dataobject)
        {
