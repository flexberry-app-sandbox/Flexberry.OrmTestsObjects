...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Apparatus2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Country2 fExporter;
        
        private NewPlatform.OrmTestsObjects.Country2 fMaker;
        ...
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Country2 Exporter
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Country2 result = this.fExporter;
        ...
        public virtual NewPlatform.OrmTestsObjects.Country2 Maker
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Country2 result = this.fMaker;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Apparatus2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Apparatus2E", typeof(NewPlatform.OrmTestsObjects.Apparatus2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Apparatus2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Apparatus2L", typeof(NewPlatform.OrmTestsObjects.Apparatus2));
                }
            }
        }
    }
