...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Salad2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Plant2 fIngridient1;
        
        private NewPlatform.OrmTestsObjects.Plant2 fIngridient2;
        ...
        [TypeUsage(new string[] {
                "NewPlatform.OrmTestsObjects.Cabbage2",
                "NewPlatform.OrmTestsObjects.Plant2"})]
        public virtual NewPlatform.OrmTestsObjects.Plant2 Ingridient1
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Plant2 result = this.fIngridient1;
        ...
        [TypeUsage(new string[] {
                ...
                "NewPlatform.OrmTestsObjects.Plant2"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Plant2 Ingridient2
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Plant2 result = this.fIngridient2;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Salad2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Salad2E", typeof(NewPlatform.OrmTestsObjects.Salad2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Salad2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Salad2L", typeof(NewPlatform.OrmTestsObjects.Salad2));
                }
            }
        }
    }
