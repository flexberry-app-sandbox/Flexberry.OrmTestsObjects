...
namespace NewPlatform.OrmTestsObjects
{
    ...
    [View("Country2L", new string[] {
            ...
            "XCoordinate as \'X coordinate\'",
            "YCoordinate as \'Y coordinate\'"})]
    public class Country2 : NewPlatform.OrmTestsObjects.Territory2
    {
        
        private string fCountryName;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfRegion fRegion;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfRegion Region
        {
            get
            {
                ...
                {
                    this.fRegion = new NewPlatform.OrmTestsObjects.DetailArrayOfRegion(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfRegion result = this.fRegion;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Country2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Country2E", typeof(NewPlatform.OrmTestsObjects.Country2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Country2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Country2L", typeof(NewPlatform.OrmTestsObjects.Country2));
                }
            }
        }
    }
