...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Лапа : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Сторона fСторона;
        ...
        private NewPlatform.OrmTestsObjects.ТипЛапы fТипЛапы;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfПерелом fПерелом;
        
        private NewPlatform.OrmTestsObjects.Кошка fКошка;
        ...
        public virtual NewPlatform.OrmTestsObjects.Сторона Сторона
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Сторона result = this.fСторона;
        ...
        public virtual NewPlatform.OrmTestsObjects.ТипЛапы ТипЛапы
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ТипЛапы result = this.fТипЛапы;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfПерелом Перелом
        {
            get
            {
                ...
                {
                    this.fПерелом = new NewPlatform.OrmTestsObjects.DetailArrayOfПерелом(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfПерелом result = this.fПерелом;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.Кошка.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Кошка Кошка
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Кошка result = this.fКошка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View k_ЛапаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("k_ЛапаE", typeof(NewPlatform.OrmTestsObjects.Лапа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КИЛ_ЛапаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КИЛ_ЛапаE", typeof(NewPlatform.OrmTestsObjects.Лапа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛапаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛапаE", typeof(NewPlatform.OrmTestsObjects.Лапа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛапаFull
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛапаFull", typeof(NewPlatform.OrmTestsObjects.Лапа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛапаShort
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛапаShort", typeof(NewPlatform.OrmTestsObjects.Лапа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЛапа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfЛапа members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfЛапа members)
        ...
        /// </summary>
        public DetailArrayOfЛапа(NewPlatform.OrmTestsObjects.Кошка fКошка) : 
                base(typeof(Лапа), ((ICSSoft.STORMNET.DataObject)(fКошка)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.Лапа this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.Лапа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.Лапа dataobject)
        {
