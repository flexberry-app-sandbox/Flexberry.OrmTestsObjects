...
namespace NewPlatform.OrmTestsObjects
{
    ...
    [View("Cabbage2L", new string[] {
            "Type as \'Type\'",
            "Name as \'Name\'"})]
    public class Cabbage2 : NewPlatform.OrmTestsObjects.Plant2
    {
        
        private string fType;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2 fCabbageParts;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2 CabbageParts
        {
            get
            {
                ...
                {
                    this.fCabbageParts = new NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfCabbagePart2 result = this.fCabbageParts;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View Cabbage2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Cabbage2E", typeof(NewPlatform.OrmTestsObjects.Cabbage2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View Cabbage2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Cabbage2L", typeof(NewPlatform.OrmTestsObjects.Cabbage2));
                }
            }
        }
    }
