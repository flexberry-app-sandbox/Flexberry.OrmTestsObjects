...
namespace NewPlatform.OrmTestsObjects
{
    ...
    [BusinessServer("NewPlatform.OrmTestsObjects.МедведьБС, OrmTestsObjects.BusinessServers", ICSSoft.STORMNET.Business.DataServiceObjectEvents.OnAllEvents)]
    [AutoAltered()]
    ...
    public class Медведь : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Пол fПол;
        
        private ICSSoft.STORMNET.UserDataTypes.NullableDateTime fДатаРождения;
        
        private NewPlatform.OrmTestsObjects.Медведь fДруг;
        
        private NewPlatform.OrmTestsObjects.Лес fЛесОбитания;
        
        private NewPlatform.OrmTestsObjects.Медведь fМама;
        
        private NewPlatform.OrmTestsObjects.Медведь fПапа;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfБерлога fБерлога;
        ...
        public virtual NewPlatform.OrmTestsObjects.Пол Пол
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Пол result = this.fПол;
        ...
        public virtual NewPlatform.OrmTestsObjects.Медведь Друг
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Медведь result = this.fДруг;
        ...
        [PropertyStorage(new string[] {
                "ЛесОбитания"})]
        public virtual NewPlatform.OrmTestsObjects.Лес ЛесОбитания
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Лес result = this.fЛесОбитания;
        ...
        [PropertyStorage(new string[] {
                "Мама"})]
        public virtual NewPlatform.OrmTestsObjects.Медведь Мама
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Медведь result = this.fМама;
        ...
        [PropertyStorage(new string[] {
                "Папа"})]
        public virtual NewPlatform.OrmTestsObjects.Медведь Папа
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Медведь result = this.fПапа;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfБерлога Берлога
        {
            get
            {
                ...
                {
                    this.fБерлога = new NewPlatform.OrmTestsObjects.DetailArrayOfБерлога(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfБерлога result = this.fБерлога;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View LoadTestView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("LoadTestView", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View OrderNumberTest
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("OrderNumberTest", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МедведьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедведьE", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МедведьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедведьL", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МедведьShort
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедведьShort", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МедведьСДелейломИВычислимымСвойством
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МедведьСДелейломИВычислимымСвойством", typeof(NewPlatform.OrmTestsObjects.Медведь));
                }
            }
        }
    }
