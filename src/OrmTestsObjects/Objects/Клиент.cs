    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TestNotStoredGuid
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TestNotStoredGuid", typeof(NewPlatform.OrmTestsObjects.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентViewE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентViewE", typeof(NewPlatform.OrmTestsObjects.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентViewL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентViewL", typeof(NewPlatform.OrmTestsObjects.Клиент));
                }
            }
        }
    }
