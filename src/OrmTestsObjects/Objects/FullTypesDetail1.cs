...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class FullTypesDetail1 : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View FullDetailView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("FullDetailView", typeof(NewPlatform.OrmTestsObjects.FullTypesDetail1));
                }
            }
        }
    }
    ...
    public class DetailArrayOfFullTypesDetail1 : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfFullTypesDetail1 members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfFullTypesDetail1 members)
        ...
        /// </summary>
        public DetailArrayOfFullTypesDetail1(NewPlatform.OrmTestsObjects.FullTypesMainAgregator fFullTypesMainAgregator) : 
                base(typeof(FullTypesDetail1), ((ICSSoft.STORMNET.DataObject)(fFullTypesMainAgregator)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.FullTypesDetail1 this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.FullTypesDetail1)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.FullTypesDetail1 dataobject)
        {
