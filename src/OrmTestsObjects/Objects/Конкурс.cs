...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Конкурс : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Состояние fСостояние;
        
        private NewPlatform.OrmTestsObjects.Пользователь fОрганизатор;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу fДокументы;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfКритерийОценки fКритерииОценки;
        ...
        public virtual NewPlatform.OrmTestsObjects.Состояние Состояние
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Состояние result = this.fСостояние;
        ...
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Пользователь Организатор
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Пользователь result = this.fОрганизатор;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfДокументацияККонкурсу result = this.fДокументы;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfКритерийОценки КритерииОценки
        {
            get
            {
                ...
                {
                    this.fКритерииОценки = new NewPlatform.OrmTestsObjects.DetailArrayOfКритерийОценки(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfКритерийОценки result = this.fКритерииОценки;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонкурсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонкурсE", typeof(NewPlatform.OrmTestsObjects.Конкурс));
                }
            }
        }
    }
