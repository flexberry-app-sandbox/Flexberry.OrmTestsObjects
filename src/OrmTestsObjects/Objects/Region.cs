...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Region : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Country2 fCountry2;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.Country2.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Country2 Country2
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Country2 result = this.fCountry2;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View RegionE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("RegionE", typeof(NewPlatform.OrmTestsObjects.Region));
                }
            }
        }
    }
    ...
    public class DetailArrayOfRegion : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfRegion members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfRegion members)
        ...
        /// </summary>
        public DetailArrayOfRegion(NewPlatform.OrmTestsObjects.Country2 fCountry2) : 
                base(typeof(Region), ((ICSSoft.STORMNET.DataObject)(fCountry2)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.Region this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.Region)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.Region dataobject)
        {
