...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class cla : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.clb fparent;
        ...
        [PropertyStorage(new string[] {
                "parent"})]
        public virtual NewPlatform.OrmTestsObjects.clb parent
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.clb result = this.fparent;
