...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class TestClassA : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.МастерМ fМастер;
        ...
        [TypeUsage(new string[] {
                "NewPlatform.OrmTestsObjects.МастерМ",
                "NewPlatform.OrmTestsObjects.НаследникМ1",
                "NewPlatform.OrmTestsObjects.НаследникМ2"})]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.МастерМ Мастер
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.МастерМ result = this.fМастер;
