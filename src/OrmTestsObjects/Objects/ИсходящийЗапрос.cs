...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class ИсходящийЗапрос : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.СтатусЗапроса fВтороеДлинноеПолеДляПроверки;
        
        private int fПятоеДлинноеПолеДляПроверки;
        
        private NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса fЭтапы;
        ...
        public virtual NewPlatform.OrmTestsObjects.СтатусЗапроса ВтороеДлинноеПолеДляПроверки
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.СтатусЗапроса result = this.fВтороеДлинноеПолеДляПроверки;
        ...
        public virtual NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса Этапы
        {
            get
            {
                ...
                if ((this.fЭтапы == null))
                {
                    this.fЭтапы = new NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса(this);
                }
                NewPlatform.OrmTestsObjects.DetailArrayOfЭтапИсходящегоЗапроса result = this.fЭтапы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИсходящийЗапросView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИсходящийЗапросView", typeof(NewPlatform.OrmTestsObjects.ИсходящийЗапрос));
                }
            }
        }
    }
