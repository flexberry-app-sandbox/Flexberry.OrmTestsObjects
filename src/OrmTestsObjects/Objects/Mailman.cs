...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Mailman : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.FileForTests fPhoto;
        ...
        public virtual NewPlatform.OrmTestsObjects.FileForTests Photo
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.FileForTests result = this.fPhoto;
