...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Перелом : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.ТипПерелома fТип;
        
        private NewPlatform.OrmTestsObjects.Лапа fЛапа;
        ...
        public virtual NewPlatform.OrmTestsObjects.ТипПерелома Тип
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.ТипПерелома result = this.fТип;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку NewPlatform.OrmTestsObjects.Лапа.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual NewPlatform.OrmTestsObjects.Лапа Лапа
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Лапа result = this.fЛапа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View k_ПереломE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("k_ПереломE", typeof(NewPlatform.OrmTestsObjects.Перелом));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереломD
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереломD", typeof(NewPlatform.OrmTestsObjects.Перелом));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереломE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереломE", typeof(NewPlatform.OrmTestsObjects.Перелом));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПерелом : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfПерелом members)

        // *** End programmer edit section *** (NewPlatform.OrmTestsObjects.DetailArrayOfПерелом members)
        ...
        /// </summary>
        public DetailArrayOfПерелом(NewPlatform.OrmTestsObjects.Лапа fЛапа) : 
                base(typeof(Перелом), ((ICSSoft.STORMNET.DataObject)(fЛапа)))
        {
        }
        
        public NewPlatform.OrmTestsObjects.Перелом this[int index]
        {
            get
            {
                return ((NewPlatform.OrmTestsObjects.Перелом)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(NewPlatform.OrmTestsObjects.Перелом dataobject)
        {
