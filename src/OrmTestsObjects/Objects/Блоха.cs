...
namespace NewPlatform.OrmTestsObjects
{
    ...
    public class Блоха : ICSSoft.STORMNET.DataObject
    {
        ...
        private NewPlatform.OrmTestsObjects.Медведь fМедведьОбитания;
        ...
        [PropertyStorage(new string[] {
                "МедведьОбитания"})]
        public virtual NewPlatform.OrmTestsObjects.Медведь МедведьОбитания
        {
            get
            {
                ...
                NewPlatform.OrmTestsObjects.Медведь result = this.fМедведьОбитания;
